 ...
 * This input type defines the necessary details required to update a comment
...
export class BoardTaskCommentUpdateInput {
  /**
   ...
   * This pinpoints the exact comment on the task that will be updated.
   */
  @Field(() => ID, {
  ...
  /**
   * The unique identifier of the task to which the comment will be updated.
